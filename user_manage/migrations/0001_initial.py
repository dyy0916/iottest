    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, max_length=150, unique=True, verbose_name='用户名')),
                ...
                ('role2', models.CharField(choices=[('SU', '超级管理员'), ('GA', '组管理员'), ('CU', '普通用户')], default='CU', max_length=2)),
